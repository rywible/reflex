...
struct FeatureDevelopmentReport {
    ...
    examples: usize,
    distinct_feature_vectors: usize,
    mixed_verdict_feature_vectors: usize,
...
pub fn feature_development(arguments: &[String]) -> Result<(), AnyError> {
    ...
    let mut report = FeatureDevelopmentReport {
        ...
        distinct_feature_vectors: comparison.distinct_feature_vectors,
        mixed_verdict_feature_vectors: comparison.mixed_verdict_feature_vectors,
