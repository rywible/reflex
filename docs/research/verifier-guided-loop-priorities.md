...
Run **Lean Comparator, Candidate Fate, and Cooperative Queue Development v1** on the existing training bundle and four held-out claims. It starts with a no-kernel audit and then uses two short search phases; it is not a new training campaign.
